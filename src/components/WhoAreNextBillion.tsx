        ...
        <ContentContainer>
          <Box gap={8} px={{ base: 8, md: 16 }} position="relative">
            ...
            <Box maxW={900}>
              ...
              <Text fontSize={18}>
              Web3 does not yet have a <i>first billion</i> users, but shifting perspectives and challenging assumptions is an evergreen endeavor 🌲. There are about <i>eight billion</i> people at the time of writing, and Ethereum is supposed to treat *every-one* fairly, (to the extent that it’s possible to treat people fairly in a world where everyone’s capabilities and needs are so different). 
              </Text>
              <Text fontSize={18}>
