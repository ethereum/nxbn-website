// colors
export const colorBlue = "#1476a0"
export const colorBlueLight = "#1688a4"
export const colorBlueLighter = "#14a8c8"
export const colorBlueLightest = "#2bbbd4"
export const colorPink = "#d85d7e"
export const colorPinkLight = "#ed8a86"
export const colorGrayLightest = "#fafafa"
export const colorGrayLighter = "#dddddd"
export const colorGrayLight = "#93979a"
...
export const colorGreen = "#629958"
export const colorGreenLight = "#91ae56"
