...
import FellowshipHeroImage from "@/public/images/fellowship/fellowship-hero.jpg"
            ...
            <H1 variant="action">The Next Billion Fellowship</H1>
              <Box maxW={600}>
                <Text mb={16}>
                  ...
                  organizational initiative, or something else entirely. There are
                  no strict requirements for Next Billion Fellowship projects,
                  save one: earnesty.
                </Text>
                <Text>
                  ...
                  Fellow&apos;s journey, but it may provide the support needed to
